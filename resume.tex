...
\begin{comment}
  - Change to letter scriptsize
  - Add more embedded experience e.g. RTOS etc
  - Add more space if possible
  - Other in skills summary to Personal Highlights or Unique Skills
  - Work on standardizing the spacing between sections via functions
\end{comment}
